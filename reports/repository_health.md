...
| Metadata Files | 5 days ago | $([ 5 -lt 0 ] && echo "Missing" || ([ 5 -lt 7 ] && echo "✅ Fresh" || ([ 5 -lt 30 ] && echo "⚠️ Needs Update" || echo "❌ Outdated"))) |
...
$([ 5 -gt 30 ] && echo "- **High Priority**: Update metadata files which are now 5 days old" || echo "")
