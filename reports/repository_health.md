...
| Metadata Files | 3 days ago | $([ 3 -lt 0 ] && echo "Missing" || ([ 3 -lt 7 ] && echo "✅ Fresh" || ([ 3 -lt 30 ] && echo "⚠️ Needs Update" || echo "❌ Outdated"))) |
...
$([ 3 -gt 30 ] && echo "- **High Priority**: Update metadata files which are now 3 days old" || echo "")
